...
Feature: Tests for t_kdit_cert_jquiza in kdit
  ...
  @execute
  Scenario: t_kdit_cert_jquiza-raw-punctual
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/kdit/raw/t_kdit_cert_jquiza/${version}/t_kdit_cert_jquiza.conf
